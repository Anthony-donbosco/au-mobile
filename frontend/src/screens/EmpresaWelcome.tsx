      ...
      <View style={styles.content}>
        <View style={[
          ...
          <Text style={[
            ...
            Como empresa, podrás gestionar las finanzas corporativas, 
            administrar empleados, generar reportes empresariales y 
            manejar múltiples cuentas de negocio.
          </Text>
