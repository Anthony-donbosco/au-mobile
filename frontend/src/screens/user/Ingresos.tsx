...
const Ingresos: React.FC<IngresosProps> = ({ onAuthChange }) => {
  ...
  const getCategoriaColor = (categoria: string) => {
    switch (categoria) {
      case 'Salario': return colors.info;
      case 'Freelance': return colors.categories.entretenimiento;
      case 'Inversiones': return colors.categories.compras;
      case 'Ventas': return colors.warning;
      default: return colors.categories.otros;
    }
  };
          ...
          {ingresos.length > 0 ? (
            ingresos.map((ingreso) => (
              <View key={ingreso.id} style={styles.ingresoItem}>
                <View style={[
                  styles.categoriaTag,
                  { backgroundColor: getCategoriaColor(ingreso.categoria) + '20' }
                ]}>
                  <Text style={[
                    styles.categoriaText,
                    { color: getCategoriaColor(ingreso.categoria) }
                  ]}>
                    {ingreso.categoria}
                  </Text>
                </View>
                ...
                <View style={styles.ingresoContent}>
                  <Text style={[styles.ingresoConcepto, isDarkMode && styles.darkText]}>
                    {ingreso.concepto}
                  </Text>
                ...
                <Text style={[styles.ingresoMonto, { color: colors.success }]}>
